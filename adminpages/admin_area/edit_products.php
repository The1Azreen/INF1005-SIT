...
/* if (isset($_GET['edit_products'])) {
    ...
    //echo $product_title;
    $product_description = $row['product _description'];
...
if (isset($_POST['edit_product'])) {
    ...
    if (
        ...
        or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_price == ''
    ) {
        ...
        product_description='$product_desc',product_keywords= '$product_keywords',category_id='$product_category',
